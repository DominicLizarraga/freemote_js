/*
      ...
      $('p').first().next().css('color', 'blue').append('<span> item</span>');
      ...
      $('p')[1].style.color = 'orange';
        ...
        */
        ...
        $('p').first().click(function(e) {
          ...
          console.log('clicked from jquery', e.currentTarget.textContent)
  ...
  $('<button>Hide Text</button>').appendTo('#main').css({color: 'white', backgroundColor: 'red'}).click(function(e) {
